...
/* ===== CONTAINER (6 PHẦN GIỮA) ===== */
.header_container{
  max-width: 1200px;   /* 6 phần */
  height: 70px;
  margin: 0 auto;      /* auto = 2 | 6 | 2 */
  padding: 0 40px;
  background-color: #000000;
  display: flex;
  align-items: center;
  ...
  <ul class="menu">
          ...
          <li class="quanly">
             ...
             <ul class="quanly-menu" id="quanly-menu">
              <li><a href="index.php?page_layout=thongtinhoivien">Quản lý hội viên</a></li>
              <li><a href="index.php?page_layout=quanlysanpham">Quản lý mặt hàng</a></li>
              <li><a href="index.php?page_layout=quanly_goitap">Quản lý gói tập</a></li>
            </ul>
          </li>
...
switch ($_GET['page_layout']) {
    ...
    case 'sanpham':
        ...
        break;
        // quanlyhoivien
    case 'thongtinhoivien':
        include 'thongtinhoivien.php';
        break;
    case 'themhoivien':
        include 'themhoivien.php';
        break;
    case 'capnhathoivien':
        include 'capnhathoivien.php';
        break;
        //quản lý sản phẩm
    case 'quanlysanpham':
