...
<body>
    ...
    <div class="marquee-text">
        ...
        <h1>Đăng Ký Gói Tập Ngày</h1>
        <p>
            Chào mừng bạn đến với dịch vụ đăng ký gói tập của chúng tôi.
            Khi đăng ký gói tập theo ngày, bạn sẽ được trải nghiệm đầy đủ
            các tiện ích và dịch vụ trong phòng tập trong vòng 24 giờ.
        </p>
        <p>
            Gói tập phù hợp cho những khách hàng mới muốn thử nghiệm môi trường
            tập luyện, trang thiết bị hiện đại cũng như chất lượng huấn luyện viên.
            Chỉ với một lần đăng ký, bạn có thể sử dụng không giới hạn các khu vực
            tập luyện trong thời gian quy định.
        </p>
        <p>
